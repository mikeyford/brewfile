...
(custom-theme-set-faces
 'mike
 '(default ((t (:family "default" :foundry "default" :width normal :height 1 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#e1e1e0" :background "#3a3a3a" :stipple nil :inherit nil))))
 ...
 '(font-lock-function-name-face ((t (:weight bold :foreground "#CC9393"))))
 '(font-lock-keyword-face ((t (:weight bold :foreground "#DFC47D"))))
